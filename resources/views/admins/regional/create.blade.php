...
<head>
    ...
    <title>Créer Admin Régional - USCIA</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>USCIA AFRIQUE - Créer un Admin Régional</h1>
        </div>
        ...
        <form method="POST" action="{{ route('admins.regional.store') }}">
            @csrf
            ...
            <div style="display: flex; gap: 10px; justify-content: space-between;">
                <a href="{{ route('admins.regional.index') }}" class="btn btn-secondary">Annuler</a>
                <button type="submit" class="btn btn-primary">Créer l'admin régional</button>
            </div>
        </form>
    </div>
</body>

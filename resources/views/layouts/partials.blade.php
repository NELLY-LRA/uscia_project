            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                <div class="sidebar-brand-icon">
                    <img alt="Logo" class="rounded-circle logo__image" width="50" height="50"
                        src="{{ asset('assets/logo-chaplain120.png') }}">
                </div>
                <span class="logo__text text-white text-lg ml-2"> USCIA </span>

            </a>
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a href="{{ route('dashboard') }}" class="btn text-start mb-2">
                    <i class="fas fa-home"></i>Dashboard
                </a>
            </li>

          <!--  <li class="nav-item">
                <a class="btn text-start mb-2" href="">
                    <i class="fas fa-th-list"></i>Add admin
                </a>
            </li>
            ...
            <li class="nav-item flex-column">
                ...
                <ul class="submenu list-unstyled ms-2" style="display: none;">
                    <li class="nav-item mb-2">
                        <a class="submenu-btn" href="{{route('add_admin')}}">
